declare module 'easyvk' {
  ...
  uploader: {
    getUploadURL(methodName: string, params: object, returnAll: boolean): Promise<any>
    uploadFile(url: string, filePath: string | fs.ReadStream, fieldName: string, params: object): Promise<any>
    uploadFetchedFile(url: string, filePath: string, fieldName: string, params: object): Promise<any>
    upload(getUrlMethod: string, getUrlParams: object, saveMethod: string, saveParams: object, file: string, isWeb: boolean): Promise<any>
  }
}
